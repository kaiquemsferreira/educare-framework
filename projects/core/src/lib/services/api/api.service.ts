...
export class ApiService {
  ...
  public get(endpoint: string, params?: any): Observable<any> {
    return this.http.get<any>(`${this.config.baseUrl}/${endpoint}`, { params });
  }

  public post(endpoint: string, body?: any, params?: any): Observable<any> {
    return this.http.post<any>(`${this.config.baseUrl}/${endpoint}`, body, { params });
  }

  public put(endpoint: string, body?: any, params?: any): Observable<any> {
    return this.http.put<any>(`${this.config.baseUrl}/${endpoint}`, body, { params });
  }

  public delete(endpoint: string, params?: any): Observable<any> {
    return this.http.delete<any>(`${this.config.baseUrl}/${endpoint}`, { params });
  }
